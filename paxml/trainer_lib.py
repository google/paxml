...
class _PjitPartitioner(Partitioner):
  ...
  def get_train_state_metadata(
    ...
    if self._auto_sharding_result and partition_specs:
      ...
      auto_sharding_spec = self._auto_sharding_result.train_state_partition_spec
      if is_eval:
        auto_sharding_spec = auto_sharding_spec.to_eval_state()
      assert (
          auto_sharding_spec == partition_specs
      ), f'{auto_sharding_spec} vs {partition_specs}'
      return train_state_metadata
